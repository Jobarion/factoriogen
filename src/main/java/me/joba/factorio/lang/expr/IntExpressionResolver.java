...
public class IntExpressionResolver extends ExpressionResolver<LanguageParser.ExprContext, ArithmeticOperator> {

    public IntExpressionResolver() {
        super(PrimitiveType.INT, PrimitiveType.INT, PrimitiveType.INT);
    }
